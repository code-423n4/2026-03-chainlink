...
contract C4PoC is Test {
    ...
    function setUp() public {
        ...
        workflowIds[0] = WorkflowRouter.SetWorkflowIdParams({
            workflowType: WorkflowRouter.WorkflowType.PRICE_ADMIN,
            workflowId: PRICE_ADMIN_WORKFLOW_ID
        });
        workflowIds[1] = WorkflowRouter.SetWorkflowIdParams({
            workflowType: WorkflowRouter.WorkflowType.AUCTION_WORKER,
            workflowId: AUCTION_WORKER_WORKFLOW_ID
        });
        workflowIds[2] = WorkflowRouter.SetWorkflowIdParams({
            workflowType: WorkflowRouter.WorkflowType.AUCTION_BIDDER,
            workflowId: AUCTION_BIDDER_WORKFLOW_ID
        });
        ...
        workflowRouter = new WorkflowRouter(
            WorkflowRouter.ConstructorParams({
                ...
                auctionBidder: address(auctionBidder),
